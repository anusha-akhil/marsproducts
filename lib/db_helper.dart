...
////////////////////////////////////////////////////
  ...
  backupDB() async {
    ...
    try {
      File ourDbFile =
          File('/data/user/0/com.example.marsproducts/databases/marsproducts.db');
      Directory? folderPathforDBfile =
          Directory('/storage/emulated/0/marsproductsDatabses/');
      await folderPathforDBfile.create();
      await ourDbFile.copy('/storage/emulated/0/marsproductsDatabses/marsproducts.db');
    } catch (e) {
  ...
  restoreDB() async {
    ...
    try {
      ...
      await saveDBFile
          .copy('/data/user/0/com.example.marsproducts/databases/marsproducts.db');
    } catch (e) {
      print("exce-=-------${e.toString()}");
    }
  }
